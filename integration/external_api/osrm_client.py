...
class OsrmClient:
    ...
    def __init__(self, base_url: str | None = None, *, timeout: float = 12.0) -> None:
        self._base_url = (
            base_url or os.getenv("OSRM_BASE_URL") or DEFAULT_OSRM_BASE_URL
        ).rstrip("/")
    ...
    def route(
        ...
        *,
        ...
        lat1, lng1 = a
        lat2, lng2 = b
        url = f"{self._base_url}/route/v1/{profile}/{lng1},{lat1};{lng2},{lat2}"
        params = {
        ...
        try:
            ...
            if geometry:
                ...
                result["path"] = [[float(lat), float(lng)] for lng, lat in coords]
            return result
        ...
        *,
        ...
        try:
            response = requests.get(
                f"{self._base_url}/route/v1/{profile}/{coords}",
                params={
                    "overview": "full",
                    "geometries": "geojson",
